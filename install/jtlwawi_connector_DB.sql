...
CREATE TABLE sql_prefix_eazysales_adminsession (
  cSessionId varchar(255)  default NULL,
  nSessionExpires int(10) unsigned default NULL,
  cSessionData text 
);

CREATE TABLE sql_prefix_eazysales_einstellungen (
...
CREATE TABLE sql_prefix_eazysales_mbestellpos (
...
CREATE TABLE sql_prefix_eazysales_martikel (
  products_id int(10) unsigned NOT NULL,
  kArtikel int(10) unsigned default NULL,
  PRIMARY KEY (products_id)
);

CREATE TABLE sql_prefix_eazysales_mkategorie (
  categories_id int(10) unsigned NOT NULL,
  kKategorie int(10) unsigned default NULL,
  PRIMARY KEY (categories_id)
);

CREATE TABLE sql_prefix_eazysales_mvariation (
...
CREATE TABLE sql_prefix_eazysales_mvariationswert (
...
CREATE TABLE sql_prefix_eazysales_sentorders (
  orders_id int(10) unsigned NOT NULL,
  dGesendet datetime default NULL,
  PRIMARY KEY (orders_id)
);

CREATE TABLE sql_prefix_eazysales_sync (
