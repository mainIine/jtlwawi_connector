...
require(DIR_FS_INC.'xtc_get_ip_address.inc.php');
require(DIR_FS_INC.'xtc_not_null.inc.php');
require(DIR_FS_INC.'xtc_get_top_level_domain.inc.php');
require(DIR_FS_CATALOG.DIR_WS_CLASSES.'class.sessions.php');
$SESS_LIFE = 3600;
$session = new sessions;

$http_domain = xtc_get_top_level_domain(defined("HTTP_SERVER") ? HTTP_SERVER : $_SERVER['HTTP_HOST']);
$https_domain = xtc_get_top_level_domain(defined("HTTPS_SERVER") ? HTTPS_SERVER : $_SERVER['HTTP_HOST']);
...
if(SESSION_FORCE_COOKIE_USE == 'true') {
	xtc_setcookie('cookie_test', 'please_accept_for_session', time() + 60 * 60 * 24 * 30, DIR_WS_CATALOG, $current_domain);
