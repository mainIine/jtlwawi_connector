...
if (auth())
{
	if (intval($_POST["action"]) == 1 && intval($_POST['KeyArtikel']))
	{
		...
		$artikel->kArtikel = iconv("ISO-8859-1","UTF-8",realEscape($_POST["KeyArtikel"]));
		$artikel->cArtNr = iconv("ISO-8859-1","UTF-8",realEscape($_POST["ArtikelNo"]));
		$artikel->cName = iconv("ISO-8859-1","UTF-8",realEscape($_POST["ArtikelName"]));
		$artikel->cBeschreibung = iconv("ISO-8859-1","UTF-8",realEscape($_POST["ArtikelBeschreibung"]));
		...
		$artikel->cAnmerkung = iconv("ISO-8859-1","UTF-8",realEscape($_POST["ArtikelAnmerkung"]));
		...
		$artikel->cKurzBeschreibung = iconv("ISO-8859-1","UTF-8",realEscape($_POST["ArtikelKurzBeschreibung"]));
		$artikel->fUVP = realEscape($_POST["ArtikelUVP"]);
		$artikel->cHersteller = iconv("ISO-8859-1","UTF-8",realEscape($_POST["Hersteller"]));
